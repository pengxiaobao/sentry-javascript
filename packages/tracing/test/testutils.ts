 ...
 *
 * Useful for running tests where some of the tested code applies to csii-sentry-node and some applies to csii-sentry-browser
 * (e.g. tests in csii-sentry-tracing or csii-sentry-hub). Note that not all properties from the browser `window` object are
 * available.
 *
