...
import { getMainCarrier, Hub } from 'csii-sentry-hub';
import * as hubModule from 'csii-sentry-hub';
import * as utilsModule from 'csii-sentry-utils'; // for mocking
import { getGlobalObject, isNodeEnv, logger } from 'csii-sentry-utils';
  ...
  describe('transaction sampling', () => {
    describe('default sample context', () => {
      it('should extract request data for default sampling context when in node', () => {
        ...
        // Ideally we'd use a NodeClient here, but csii-sentry-tracing can't depend on csii-sentry-node since the reverse is
