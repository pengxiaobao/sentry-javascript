...
import { getCurrentHub, Hub } from 'csii-sentry-browser';
import { Integration, IntegrationClass, Span, Transaction } from 'csii-sentry-types';
...
/** @deprecated remove when csii-sentry-apm no longer used */
...
class Profiler extends React.Component<ProfilerProps> {
  ...
  public constructor(props: ProfilerProps) {
    ...
    // If they are using csii-sentry-apm, we need to push/pop activities
